...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Save JWT and server-confirmed user details after password login
      setAuth(token, user);
  ...
  return (
    <div className="auth-page">
      <div className="auth-brand">
        ...
        <div className="auth-hospital-photo-wrap">
          <img
            className="auth-hospital-photo"
            src={hospitalImage}
            alt="Badulla Hospital"
          />
        </div>

        <h1>Badulla Hospital PMTS Portal</h1>
      ...
      <div className="auth-form-panel">
        <div className="auth-form-container animate-fade-in">
          ...
          {resetSuccess && (
            <div className="alert alert-success">Password changed successfully. Sign in with your new password.</div>
          )}
